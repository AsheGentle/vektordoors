...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': '809018cde6c1a40d2af29f6329ed2f45',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 780
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
            'AJAX_CALL': 'Y'
        };
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': '12b3454998b69a31ed4e3ec7c8e0b1b5',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 779
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': 'bb91b1a436e6bae8527bf39038725909',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 778
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': 'f790bdefccf9adc0cb14a916bc5cde96',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 777
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': '813b798727fc763962371cdf0a3b3d78',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 776
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': 'b28b8b99de5786c18abee043ff9609c9',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 775
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
...
(function($, api){
    ...
    votes.each(function(){
        ...
        var value = vote.data('value');
        var arParams = {
            'SESSION_PARAMS': 'e5ca47d5151d26e81aee26dfba109561',
            'PAGE_PARAMS': {
                'ELEMENT_ID': 774
            },
            'sessid': '960958023c4fcdfcdd626aa5d3628352',
